<script lang="ts">
  ...
  const social_links = [
    ...
    { icon: YouTube, href: "https://www.youtube.com/@aemersllc" },
    { icon: LinkedIn, href: "https://www.linkedin.com/company/aemer-s-llc/" },
  ];
</script>
    ...
    >
      <div class="flex flex-col gap-y-3">
        ...
        <span class="text-sm md:text-base text-lightColor"
          >Our diverse services are crafted in such a way that all of our valued
          stakeholders discover the scholarship journey to be truly lovable.</span
        >
        <div class="flex items-center gap-x-2">
          {#each social_links as link}
            <a href={link.href} target="_blank" rel="noreferrer"
              ><span class="block w-6 h-6 text-primary"
                ><svelte:component this={link.icon} /></span
              ></a
            >
          {/each}
        </div>
      ...
      <div>
        ...
        <div class="mt-3 flex flex-col items-start space-y-2">
      ...
      <div>
        ...
        <div class="mt-3 flex flex-col items-start space-y-2">
          <a
            href="https://app.aemers.com"
            target="_blank"
            rel="noreferrer"
            class="footer-link">app.aemers</a
          >
          <a
            href="https://kb.aemers.com"
            target="_blank"
            rel="noreferrer"
            class="footer-link">Knowledgebase</a
          >
          <a
            href="https://sat.aemers.com"
            target="_blank"
            rel="noreferrer"
            class="footer-link">SAT by Aemers</a
          >
        </div>
      </div>
