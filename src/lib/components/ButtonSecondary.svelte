<script lang="ts">
  ...
  export let defaultClass: string = `inline-flex items-center justify-center border ${
    whiteBG ? "bg-white border-white" : "bg-transparent border-primary"
  } disabled:bg-borderColor hover:bg-primary text-primary hover:text-white font-bold text-sm md:text-base rounded-xl`;
